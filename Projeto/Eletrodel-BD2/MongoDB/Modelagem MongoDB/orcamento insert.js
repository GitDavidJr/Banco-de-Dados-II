...
db.orcamento.insertMany([
  {
    ...
    descricao_problema: "Problema com a câmera",
    ...
    servico: {
      ...
      descricao_solucao: "Substituição da câmera",

      cpf_funcionario: "65432109876",

      tipo_servico: "Substituição de câmera",
...

  {
    ...
    servico: {
      ...
      tipo_servico: "Substituição de tela",
...

  {
    ...
    servico: {
      ...
      descricao_solucao: "Reinstalação do sistema operacional",
...

  {
    ...
    servico: {
      ...
      descricao_solucao: "Substituição da tela",
...

  {
    ...
    servico: {
      ...
      tipo_servico: "Reinstalação do sistema operacional",
...

  {
    ...
    servico: {
      ...
      tipo_servico: "Atualização de firmware",
...

  {
    ...
    servico: {
      ...
      tipo_servico: "Reparo de placa-mãe",
...

  {
    ...
    servico: {
      ...
      tipo_servico: "Substituição de alto-falante",
